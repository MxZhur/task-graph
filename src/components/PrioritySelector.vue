...
<template>
    <div>
        <button type="button" @click.prevent="setValue(TASK_PRIORITIES.none)" title="None"
            class="border border-gray-400 rounded-s-lg p-2" :class="{ active: value === TASK_PRIORITIES.none }">
        ...
        <button type="button" @click.prevent="setValue(TASK_PRIORITIES.low)" title="Low"
            class="border-t border-b border-gray-400 p-2" :class="{ active: value === TASK_PRIORITIES.low }">
        ...
        <button type="button" @click.prevent="setValue(TASK_PRIORITIES.medium)" title="Meduim"
            class="border border-gray-400 p-2" :class="{ active: value === TASK_PRIORITIES.medium }">
        ...
        <button type="button" @click.prevent="setValue(TASK_PRIORITIES.high)" title="High"
            class="border-t border-b border-gray-400 p-2" :class="{ active: value === TASK_PRIORITIES.high }">
        ...
        <button type="button" @click.prevent="setValue(TASK_PRIORITIES.critical)" title="Critical"
            class="border border-gray-400 rounded-e-lg p-2" :class="{ active: value === TASK_PRIORITIES.critical }">
